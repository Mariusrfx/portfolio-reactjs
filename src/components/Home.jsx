  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          <p className=' text-[#ccd6f6] '>Hola, mi nombre es</p>
          <h1 className='text-4xl sm:text-7xl font-bold text-blue-500 '>Marius</h1>
          <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>soy web developer</h2>
          <p className='text-[#8892b0] py-4 max-w-[700px]'>Web Developer / QA Automation Tester </p>
          <div>
