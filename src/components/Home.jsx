  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
          ...
          <div>
            <button>
          <Link className='text-white border-2 px-6 py-3 my-2 flex items-center bg-[#0a192f] transition duration-150 ease-in-out hover:bg-[#0e2341] cursor:p' to="work"  smooth={true} duration={500} >
          Ver Proyectos <HiOutlineArrowNarrowDown/>
        </Link></button>
